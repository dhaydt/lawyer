...
<div class="container-xxl d-flex align-items-center flex-lg-stack">
    ...
    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-2 me-lg-5">
        ...
        <div class="flex-grow-1">
            ...
            <!--begin::Header Logo-->
            <a href="javascript:">
                <img alt="Logo" src="{{ asset('assets_metronic/media/logos/default-small.svg') }}"
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets_metronic/media/avatars/300-6.jpg') }}" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div
                                ...
                                <a href="#"
                                    ...
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets_metronic/media/avatars/300-2.jpg') }}" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div
                                ...
                                <a href="#"
                                    ...
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets_metronic/media/avatars/300-9.jpg') }}" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div
                                ...
                                <a href="#"
                                    ...
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets_metronic/media/avatars/300-11.jpg') }}" alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets_metronic/media/svg/brand-logos/volicity-9.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets_metronic/media/svg/brand-logos/tvit.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets_metronic/media/svg/misc/infography.svg') }}" alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets_metronic/media/svg/brand-logos/leaf.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#"
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets_metronic/media/svg/brand-logos/tower.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="{{ asset('assets_metronic/media/avatars/300-1.jpg') }}" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                        <div class="d-flex flex-column">
                        ...
                        <span class="menu-title position-relative">Language
                            <span
                                ...
                                <img class="w-15px h-15px rounded-1 ms-2"
                                    src="{{ asset('assets_metronic/media/flags/united-states.svg') }}"
                                    alt="" /></span></span>
                    </a>
                    <!--begin::Menu sub-->
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5 active">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1"
                                        src="{{ asset('assets_metronic/media/flags/united-states.svg') }}" alt="" />
                                </span>English</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('assets_metronic/media/flags/spain.svg') }}"
                                        alt="" />
                                </span>Spanish</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('assets_metronic/media/flags/germany.svg') }}"
                                        alt="" />
                                </span>German</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('assets_metronic/media/flags/japan.svg') }}"
                                        alt="" />
                                </span>Japanese</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('assets_metronic/media/flags/france.svg') }}"
                                        alt="" />
                                </span>French</a>
                        </div>
                        <!--end::Menu item-->
