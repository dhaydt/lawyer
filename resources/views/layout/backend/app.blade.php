...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-enabled">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            @include('layout.backend.navbar._sidebar')
            <!--begin::Wrapper-->
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                @include('layout.backend.navbar._header')
                <!--begin::Container-->
                ...
                <!--end::Container-->
                @include('layout.backend.navbar._footer')
            </div>
            <!--end::Wrapper-->
        </div>
        <!--end::Page-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo14/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 13:54:36 GMT -->
