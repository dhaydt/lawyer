    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 me-n4 pe-4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-sub-indention menu-active-bg menu-state-primary menu-title-gray-700 fs-6 menu-rounded w-100 fw-semibold"
                ...
                <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">About Us</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/about_us')?'active':''}}"
                ...
                <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Company & Organization</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/organization')?'active':''}}"
                        ...
                        <span class="menu-title">Company Page Content</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/client')?'active':''}}"
                        ...
                        <span class="menu-title">Company Client List</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/gallery')?'active':''}}"
                        ...
                        <span class="menu-title">Gallery Documentation</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/laws')?'active':''}}"
                        href="{{ route('admin.laws.list') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <span class="menu-title">Laws</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/applied')?'active':''}}"
                        href="{{ route('admin.applied') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="menu-item">
                    <a class="menu-link  {{Request::is('admin/recruitment')?'active':''}}"
                        href="{{ route('admin.recruitment') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
